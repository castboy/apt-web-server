...
type UgcMoldCountController struct{}

var UgcMoldCountObj = new(UgcMoldCountController)

func (this *UgcMoldCountController) Get(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	//check ssn
	//TODO
	//parse parament
	input := UgcMoldCountGetInput{}
	...
	err, list := new(urgency.TblUgcMCount).GetUgcMCount(&input.Para)
	if err != nil {
...
type UgcMoldCountGetInput struct {
	Para urgency.TblUgcMCountSearchPara
}
